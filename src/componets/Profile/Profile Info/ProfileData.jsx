...
const ProfileData = ({ profile, updateProfileData, isOwner, error, loaderProfile, loaderProfileData }) => {
  ...
  return (
    <>
      ...
      <div className="MyTextInput">
        <input
          className={`text-input, ${meta.touched && !field.value ? "input-touched" : null
            }`}
          {...field}
          {...props}
        />
